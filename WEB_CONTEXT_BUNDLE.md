...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-b9086c036f41a2c2"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-b9086c036f41a2c2",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-b9086c036f41a2c2",
        "url": "https://en.wikipedia.org/wiki/Montgomery%27s_pair_correlation_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Montgomery's pair correlation conjecture : the normalized pair correlation function between pairs of zeros of the Riemann zeta function is the same as the pair correlation function of random Hermitian matrices .",
      "version": 1
    },
    "title": "Montgomery's pair correlation conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "eaa347d99848351faa4cb0394727707366d99b994ea8b8ec4bb97fab9f01ddd1"
}
```
